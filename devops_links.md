...
* [mount/fstab](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-using-volumes.html)
* [swap](https://www.digitalocean.com/community/tutorials/how-to-add-swap-on-ubuntu-14-04)
* [nginx & redirect (com Jenkins)](https://wiki.jenkins-ci.org/display/JENKINS/Jenkins+behind+an+NGinX+reverse+proxy)
* [https](https://www.digitalocean.com/community/tutorials/how-to-create-an-ssl-certificate-on-nginx-for-ubuntu-14-04)
